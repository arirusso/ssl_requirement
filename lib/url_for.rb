...
module ActionDispatch
  module Routing
    class RouteSet
      ...
      def url_for_with_secure_option(*args, &block)
        options = args.first
      ...
      def url_for_with_non_ssl_host(*args, &block)
        ...
        url_for_without_non_ssl_host(*args, &block)
      end
